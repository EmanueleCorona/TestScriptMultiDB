...
public class TestScriptConst {
    ...
    public static final String ACOM = "_ACOM";
    ...
    public static class Menu {
        public static final String HEADER = NEW_LINE + "========== Test Script MultiDB ==========";
        ...
        public static final String CHOOSE_OPTION = NEW_LINE + "Scegliere un'opzione: ";
    }
    ...
    public static class Error {
        public static final String OPTION_NOT_VALID = "Opzione non valida, scegliere un'opzione: ";
        public static final String FILE_NOT_FOUND = "Il file non è stato trovato all'interno del percorso indicato";
        public static final String FILE_WRITING = "Errore durante il tentativo di scrittura su file";
        public static final String CLOSING_READER = "Errore durante la chiusura del file di lettura";
        public static final String CLOSING_WRITER = "Errore durante la chiusura del file di scrittura";
    }
}
